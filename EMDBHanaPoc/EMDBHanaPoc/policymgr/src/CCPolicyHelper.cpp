                                  ...
                                  const std::string &strPolicyTag, std::list<std::string> &lstPolicyID)
{
    ...
    while (true)
    {
        ...
        {
            hand_lefte_exception(" CCLoginHelper::SearchPolicy ");
            return;
        }
                                  ...
                                  std::string &strNewCriteria)
{
    ...
    {
        hand_lefte_exception("set policy tag to criteria");
        return false;
    }
                                      ...
                                      const std::string &strPolicyID, pt::ptree &ptreePolicy)
{
    ...
    {
        hand_lefte_exception(" CCLoginHelper::GetPolicyDetails ");
        return;
    }
    ...
    if (res.result() == http::status::ok)
    {
        ...
        try
        {
            ...
            if (strStatusCode == HTTP_GET_SUCCESS)
            {
                ...
                //name
                std::string str_name = ptData.get<std::string>("fullName");
                ptreePolicy.put<std::string>("fullname", str_name);
        ...
        {
            hand_lefte_exception(" CCPolicyHelper::GetPolicyDetails Parse result ");
            return;
        }
    }
    ...
    {
        hand_lefte_exception(" CCPolicyHelper::GetPolicyDetails query action component ");
        return;
    }
    ...
    {
        hand_lefte_exception(" CCPolicyHelper::GetPolicyDetails query subject component ");
        return;
    }
    ...
    {
        hand_lefte_exception(" CCPolicyHelper::GetPolicyDetails query resource component ");
        return;
    }
...
bool CCPolicyHelper::ExtraceObligationsFromPolicy(const pt::ptree &ptDenyOb, pt::ptree &ptObs)
{
    ...
    {
        hand_lefte_exception("  CCPolicyHelper::ExtraceObligations ");
        return false;
    }
...
bool CCPolicyHelper::ExtraceComponentFromPolicy(const pt::ptree &ptComponents, pt::ptree &ptPolicyComponents)
{
    ...
    {
        hand_lefte_exception("  CCPolicyHelper::ExtraceComponentFromPolicy ");
        return false;
    }
                                           ...
                                           pt::ptree& ptComponent, const std::string& strID)
{
    ...
    if(QueryComponent(httpClient, strSessionCookie, ptComponentData, strID))
    {
        ...
        {
            hand_lefte_exception(" CCPolicyHelper::QueryActionComponent Parse result ");
            return false;
        }
    }
                                      ...
                                      pt::ptree& ptComponent, const std::string& strID)
{
    ...
    if(QueryComponent(httpClient, strSessionCookie, ptComponentData, strID))
    {
        ...
        {
            hand_lefte_exception(" CCPolicyHelper::QuerySubjectComponent Parse result ");
            return false;
        }
    }
                                      ...
                                      pt::ptree& ptComponent, const std::string& strID)
{
    ...
    if(QueryComponent(httpClient, strSessionCookie, ptComponentData, strID))
    {
        ...
        {
            hand_lefte_exception(" CCPolicyHelper::QueryResourceComponent Parse result ");
            return false;
        }
    }
                                    ...
                                    pt::ptree& ptComponentData, const std::string& strID)
{
    ...
    {
        hand_lefte_exception(" CCLoginHelper::QueryComponent ");
        return false;
    }
